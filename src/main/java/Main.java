...
public class Main {
    ...
    private static ByteBuffer constructResponse(int correlationId, int errorCode) throws IOException {
        ...
        baos.write(ByteBuffer.allocate(2).putShort((short) 0).array()); // Min version: 0 (2 bytes)
        baos.write(ByteBuffer.allocate(2).putShort((short) 4).array()); // Max version: 4 (2 bytes)
        ...
        baos.write(ByteBuffer.allocate(2).putShort((short) 0).array()); // Min version: 0 (2 bytes)
        baos.write(ByteBuffer.allocate(2).putShort((short) 0).array()); // Max version: 0 (2 bytes)
        baos.write(0); // TAG_BUFFER: empty
